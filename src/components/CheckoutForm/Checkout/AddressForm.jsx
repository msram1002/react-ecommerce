...
const AddressForm = ({ checkoutToken, next }) => {
  ...
  const subdivisions = Object.entries(shippingSubdivisions).map(([subdivCode, subdivName]) => ({ id: subdivCode, label: subdivName}));
  ...
  return (
    <>
      ...
      <FormProvider {...methods}>
        {/* Creating a new object passing all necessary data */}
        <form
